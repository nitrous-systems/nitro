...
box_bins := "nitro-server nitro-session nitro-shot nitro-demo nitro-bench nitro-calc nitro-chess nitro-term nitro-files nitro-bar nitro-launcher nitro-wallpaper nitro-settings hey"
